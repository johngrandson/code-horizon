defmodule CodeHorizonWeb.Admin.PostLiveTest do
  use CodeHorizonWeb.ConnCase

  import CodeHorizon.PostsFixtures
  ...
  describe "File Selector" do
    import CodeHorizon.FilesFixtures
    ...
    test "File upload and add", %{conn: conn, post: post} do
      ...
      file = CodeHorizon.Repo.get_by(File, name: "test.jpg")
    ...
    test "Archiving file removes it from the list", %{conn: conn, post: post} do
      ...
      CodeHorizon.Files.archive_file(file)
