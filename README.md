<p align="center">
  <img src="https://res.cloudinary.com/wickedsites/image/upload/v1650064156/petal/code_horizon_jbuqvj.png" height="128">
...
If you don't meet this assumptions you can read our [comprehensive install instructions](https://docs.petal.build/code-horizon-documentation/fundamentals/installation).
...
- Optional: Follow our tutorial ["Creating a web app from start to finish"](https://docs.petal.build/code-horizon-documentation/guides/creating-a-web-app-from-start-to-finish) to get an overview of Petal Pro
...
```
mix rename CodeHorizon MyTwitterClone
```
