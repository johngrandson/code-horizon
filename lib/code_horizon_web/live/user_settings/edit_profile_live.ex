defmodule CodeHorizonWeb.EditProfileLive do
  @moduledoc false
  use CodeHorizonWeb, :live_view

  import CodeHorizonWeb.UserSettingsLayoutComponent

  alias CodeHorizon.Accounts
  alias CodeHorizon.Accounts.User
  alias CodeHorizonWeb.FileUploadComponents

  # SETUP_TODO: pick a storage option for images below.
  # Cloudinary setup info: /lib/code_horizon/file_uploads/cloudinary.ex
  # S3 setup info: /lib/code_horizon/file_uploads/s3.ex
  ...
  @upload_provider CodeHorizon.FileUploads.Local
  # @upload_provider CodeHorizon.FileUploads.Cloudinary
  # @upload_provider CodeHorizon.FileUploads.S3
