defmodule CodeHorizonWeb.UserRegistrationLiveTest do
  ...
  describe "Registration page" do
    ...
    test "redirects if already logged in", %{conn: conn} do
      ...
      result =
        ...
        |> follow_redirect(conn, CodeHorizonWeb.Helpers.home_path(user))
  ...
  describe "register user" do
    test "creates account and logs the user in", %{conn: conn} do
      ...
      user = CodeHorizon.Repo.last(CodeHorizon.Accounts.User)
      assert redirected_to(conn) == CodeHorizonWeb.Helpers.home_path(user)

      # Now do a logged in request and assert on the menu
      conn = get(conn, CodeHorizonWeb.Helpers.home_path(user))
