defmodule CodeHorizonWeb.AdminDashboardLive do
  @moduledoc false
  use CodeHorizonWeb, :live_view

  import CodeHorizonWeb.AdminLayoutComponent
  import CodeHorizonWeb.Components.DashboardComponents

  alias CodeHorizon.Accounts.UserQuery
  alias CodeHorizon.Orgs.Org
  alias CodeHorizon.Repo
  alias CodeHorizonWeb.AdminChartDataHelper

  @impl true
  def mount(_params, _session, socket) do
    if connected?(socket),
      do: Phoenix.PubSub.subscribe(CodeHorizon.PubSub, "admin_dashboard:stats")
  ...
  def notify_admin_stats, do: Phoenix.PubSub.broadcast(CodeHorizon.PubSub, "admin_dashboard:stats", "admin_stats")
end
