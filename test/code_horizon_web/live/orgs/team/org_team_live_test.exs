defmodule CodeHorizonWeb.OrgTeamLiveTest do
  ...
  test "deletes member", %{conn: conn, org: org, user: user} do
    ...
    CodeHorizonWeb.Endpoint.subscribe(CodeHorizonWeb.UserAuth.user_session_topic(token))
    ...
    assert topic == CodeHorizonWeb.UserAuth.user_session_topic(token)
