defmodule CodeHorizon.Notifications.UserMailer do
  @moduledoc """
  When sending an email we use the functions in CodeHorizon.Email to generate the Email struct ready for Swoosh to send off.
  ...
  """
  alias CodeHorizon.Email
  alias CodeHorizon.Mailer
