defmodule CodeHorizon.Accounts.UserSeeder do
  @moduledoc """
  ...
  def fake_subscription(%Accounts.User{} = user) do
    ...
    {:ok, customer} =
      CodeHorizon.Billing.Customers.create_customer_for_source(:user, user.id, %{
        email: user.email,
        provider: "stripe",
        provider_customer_id: "cus_123"
      })

    CodeHorizon.Billing.Subscriptions.create_subscription!(%{
      status: "active",
      plan_id: "plan_123",
