...
config :code_horizon, :cloudinary,
...
config :code_horizon, :stripe_production_mode, System.get_env("STRIPE_PRODUCTION_MODE") == "true"
...
if config_env() == :prod do
  ...
  config :code_horizon, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :code_horizon, CodeHorizon.Mailer,
