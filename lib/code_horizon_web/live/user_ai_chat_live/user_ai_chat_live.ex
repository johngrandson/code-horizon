defmodule CodeHorizonWeb.UserAiChatLive do
  @moduledoc """
  The user AI Chat live view.

  **In case you need some more rules for the Chatbot to adhere to, just expand on the Markdown in the `CodeHorizonWeb.UserAiChatLive.OpenAI.default_messages/0` function.**
  """
  use CodeHorizonWeb, :live_view

  alias CodeHorizonWeb.LangChainHelpers
  alias CodeHorizonWeb.UserAiChatLive.LangChain
  alias CodeHorizonWeb.UserAiChatLive.Message
