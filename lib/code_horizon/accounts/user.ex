defmodule CodeHorizon.Accounts.User do
  @moduledoc false
  ...
  typed_schema "users" do
    ...
    field :is_subscribed_to_marketing_notifications, :boolean, default: !CodeHorizon.gdpr_mode()
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, CodeHorizon.Repo)
  ...
  """
  def valid_password?(%CodeHorizon.Accounts.User{hashed_password: hashed_password}, password)
