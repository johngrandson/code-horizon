defmodule CodeHorizon.Billing.Providers.Stripe.Services.CreateCheckoutSessionTest do
  ...
  describe "call/1" do
    test "creates a checkout session" do
      ...
      use_cassette "CodeHorizon.Billing.Providers.Stripe.Services.CreateCheckoutSession.call" do
        assert {:ok,
