defmodule CodeHorizonWeb.AdminRoutes do
  @moduledoc false
    ...
    quote do
      scope "/admin", CodeHorizonWeb do
        ...
        live_session :require_admin_user,
          on_mount: [
            {CodeHorizonWeb.UserOnMountHooks, :require_admin_user}
          ] do
