defmodule CodeHorizon.Accounts.UserPin do
  @moduledoc false
  ...
  defp get_hashed_pin(pin),
    do: :crypto.mac(:hmac, :sha256, Application.get_env(:code_horizon, CodeHorizonWeb.Endpoint)[:secret_key_base], pin)
