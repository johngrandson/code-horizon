defmodule CodeHorizon.Accounts.NotificationSubscriptions do
  @moduledoc false
  ...
  def toggle_user_subscription(user, notification_subscription_name) do
    ...
    if notification_subscription do
      ...
      case CodeHorizon.Accounts.update_user_as_admin(user, user_updates) do
        {:ok, _user} ->
          true
  ...
  def unsubscribe_url(user, notification_subscription_name) do
    CodeHorizonWeb.Router.Helpers.user_settings_url(
