defmodule CodeHorizon.Slack do
  @moduledoc """
  ...
  6. Run `iex -S mix phx.server` and then `CodeHorizon.Slack.read_channels`
  7. Get the channel ID of the channel you want to post to. Put it in a new environment variable SLACK_CHANNEL_ID
  8. Run CodeHorizon.Slack.message("Hello world") to test it out!
  """
  use Tesla
