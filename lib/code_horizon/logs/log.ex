defmodule CodeHorizon.Logs.Log do
  @moduledoc false
  ...
  typed_schema "logs" do
    ...
    belongs_to :target_user, CodeHorizon.Accounts.User
    belongs_to :org, CodeHorizon.Orgs.Org
    belongs_to :customer, CodeHorizon.Billing.Customers.Customer, foreign_key: :billing_customer_id
