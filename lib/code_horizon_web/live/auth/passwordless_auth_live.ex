defmodule CodeHorizonWeb.PasswordlessAuthLive do
  @moduledoc """
  ...
  defp handle_validation(socket, {:error, :too_many_incorrect_attempts}) do
    ...
    CodeHorizon.Logs.log_async("passwordless_pin_too_many_incorrect_attempts", %{
      user: socket.assigns.auth_user
    })
  ...
  defp handle_validation(socket, {:error, :expired}) do
    ...
    CodeHorizon.Logs.log_async("passwordless_pin_expired", %{
      user: socket.assigns.auth_user
    })
