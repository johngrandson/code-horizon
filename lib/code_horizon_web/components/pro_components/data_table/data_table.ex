defmodule CodeHorizonWeb.DataTable do
  @moduledoc """
  ...
  ## Example
      ...
      defmodule MyAppWeb.PostLive.Index do
        ...
        def handle_params(params, _url, socket) do
          starting_query = CodeHorizon.Widgets.Widget
  ...
  alias CodeHorizonWeb.DataTable.Cell
  alias CodeHorizonWeb.DataTable.Filter
  alias CodeHorizonWeb.DataTable.FilterSet
  alias CodeHorizonWeb.DataTable.Header
