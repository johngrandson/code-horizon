defmodule CodeHorizonWeb.Helpers do
  @moduledoc """
  ...
  def main_menu_items(current_user) do
    CodeHorizonWeb.Menus.main_menu_items(current_user)
  end

  def user_menu_items(current_user) do
    CodeHorizonWeb.Menus.user_menu_items(current_user)
  end

  def public_menu_items(current_user) do
    CodeHorizonWeb.Menus.public_menu_items(current_user)
  end

  def get_menu_item(name, current_user) do
    CodeHorizonWeb.Menus.get_link(name, current_user)
  end
