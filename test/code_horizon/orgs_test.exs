defmodule CodeHorizon.OrgsTest do
  use CodeHorizon.DataCase

  import CodeHorizon.AccountsFixtures
  import CodeHorizon.NotificationsFixtures
  import CodeHorizon.OrgsFixtures

  alias CodeHorizon.Notifications
  alias CodeHorizon.Notifications.UserNotification
  alias CodeHorizon.Orgs
  alias CodeHorizon.Orgs.Invitation
  alias CodeHorizon.PubSub
  ...
  describe "send_org_invitation/3" do
    ...
    test "new email - creates org invite and delivers via email", %{
      ...
      Mimic.expect(CodeHorizon.Notifications.UserMailer, :deliver_org_invitation, fn _, _, _ ->
        {:ok, Swoosh.Email.new()}
      end)
