defmodule CodeHorizon.Billing.Customers.Customer do
  @moduledoc """
  ...
  typed_schema "billing_customers" do
    ...
    has_many :subscriptions, CodeHorizon.Billing.Subscriptions.Subscription, foreign_key: :billing_customer_id
