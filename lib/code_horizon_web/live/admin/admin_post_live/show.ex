defmodule CodeHorizonWeb.AdminPostLive.Show do
  @moduledoc false
  ...
  @impl true
  def handle_info({CodeHorizonWeb.AdminFilesLive.FormComponent, :file_added}, socket) do
    {:noreply, assign(socket, :files, Files.list_files())}
  end

  @impl true
  def handle_info({CodeHorizonWeb.AdminFilesLive.FilesComponent, :file_archived}, socket) do
    {:noreply, assign(socket, :files, Files.list_files())}
  end
