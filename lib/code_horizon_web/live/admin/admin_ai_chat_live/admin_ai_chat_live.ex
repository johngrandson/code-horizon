defmodule CodeHorizonWeb.AdminAiChatLive do
  @moduledoc """
  ...
  **In case you need some more rules for the Chatbot to adhere to, just expand on the Markdown in the `CodeHorizonWeb.AdminAiChatLive.LangChain.assistant/1` function.**
  """
  use CodeHorizonWeb, :live_view

  import CodeHorizonWeb.AdminLayoutComponent

  alias CodeHorizonWeb.AdminAiChatLive.LangChain
  alias CodeHorizonWeb.AdminAiChatLive.Message
  alias CodeHorizonWeb.LangChainHelpers
  ...
  defp unsafe_markdown(assigns) do
    ...
    <div class={[
      ...
      {raw(
        CodeHorizon.MarkdownRenderer.to_html(@content, %Earmark.Options{
