defmodule CodeHorizonWeb.UserSettingsControllerTest do
  ...
  describe "GET /users/unsubscribe/:code/:notification_subscription" do
    test "renders an unsubscribe page for that notification subscription", %{
      ...
      unsub_url =
        CodeHorizon.Accounts.NotificationSubscriptions.unsubscribe_url(
          user,
      ...
      assert response =~
               CodeHorizon.Accounts.NotificationSubscriptions.get("marketing_notifications").label
    end
  end
