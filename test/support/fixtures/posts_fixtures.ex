defmodule CodeHorizon.PostsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `CodeHorizon.Posts` context.
  """

  alias CodeHorizon.AccountsFixtures
  ...
  def published_post_fixture(attrs \\ %{}) do
    ...
    {:ok, published_post} =
      CodeHorizon.Posts.publish_post(post, %{
