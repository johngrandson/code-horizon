defmodule CodeHorizonWeb.OrgPlugsTest do
  use CodeHorizonWeb.ConnCase, async: true

  setup :register_and_sign_in_user

  setup do
    other_user = CodeHorizon.AccountsFixtures.confirmed_user_fixture(%{is_onboarded: true})
    other_org = CodeHorizon.OrgsFixtures.org_fixture(other_user)
