defmodule CodeHorizonWeb.LogsLive do
  @moduledoc """
  ...
  alias CodeHorizon.Logs.LogQuery
  alias CodeHorizon.Repo
  alias CodeHorizonWeb.LogsLive.LogDataTableSettings
  alias CodeHorizonWeb.LogsLive.SearchChangeset
  ...
  def mount(params, _session, socket) do
    if connected?(socket) do
      CodeHorizonWeb.Endpoint.subscribe("logs")
    end
