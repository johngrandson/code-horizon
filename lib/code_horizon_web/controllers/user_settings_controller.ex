defmodule CodeHorizonWeb.UserSettingsController do
  use CodeHorizonWeb, :controller

  alias CodeHorizon.Accounts
  alias CodeHorizon.Accounts.NotificationSubscriptions
  ...
  def update_password(conn, params) do
    ...
    case Accounts.update_user_password(user, password, user_params) do
      ...
      {:error, changeset} ->
        ...
        |> put_flash(
          :error,
          CodeHorizonWeb.CoreComponents.combine_changeset_error_messages(changeset)
        )
