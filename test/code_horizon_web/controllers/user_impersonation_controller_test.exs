defmodule CodeHorizonWeb.UserImpersonationControllerTest do
  ...
  describe "POST /auth/impersonate" do
    ...
    test "impersonated user has impersonator_user_id", %{
      ...
      current_user = CodeHorizon.Accounts.get_user_by_session_token(get_session(conn, :user_token))
    ...
    test "admin can't impersonate another admin", %{
      ...
      {:ok, user} = CodeHorizon.Accounts.update_user_as_admin(user, %{role: :admin})
