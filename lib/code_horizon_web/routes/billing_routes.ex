defmodule CodeHorizonWeb.BillingRoutes do
  @moduledoc false
  defmacro __using__(_) do
    quote do
      # :subscribe menu item is in CodeHorizonWeb.Menus
      ...
      scope "/org/:org_slug" do
        # :org_subscribe menu item is in CodeHorizonWeb.OrgLayoutComponent
